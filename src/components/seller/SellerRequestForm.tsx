...
import { becomeSeller } from "../../services/seller/SellerService";
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <TabView className="p-5" activeIndex={index}>
                        ...
                        <TabPanel header="Documents">
                            ...
                            <button type="submit" className="bg-[#5BD899] text-white text-xl font-serif rounded-lg drop-shadow-xl m-1 px-4 py-3">Submit </button>
                        </TabPanel>
                    </TabView>
                </form>
