        ...
        <>
            <section>
                <div className={`${style.bg} flex items-center `}>
                    <div className="backdrop-blur-sm bg-white/60 mx-20 p-4 rounded-lg">
                        <p className="text-white text-sm leading-10 md:text-3xl font-['Cyborg'] ">It's free to be on Biz365</p>
                        ...
                        <p className="text-green-600 text-sm md:text-xl font-['Cyborg'] py-5">Become Seller Now</p>
                        <button className="text-white bg-green-600 rounded-md p-3 font-['Cyborg'] shadow-lg shadow-green-600 hover:text-green-600 hover:bg-white">
            ...
            <section className="section-2 my-10">
                ...
                <div className="grid grid-cols-2 justify-center">
                    <a href="/home/about-us" className={`${style.card} col-span-2 md:col-span-1`}>
                        <img
