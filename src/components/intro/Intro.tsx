...
function Intro() {
  return (
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4 md:h-screen h-full">
        <div className="px-5 py-9">
          <h1 className="text-green-600 p-2 text-3xl md:text-6xl font-bold font-['Cyborg']">Business365 <br /><span className='text-black text-2xl md:text-3xl p-2 underline decoration-green-600 decoration-6'> Where Local Meets Global</span></h1>
